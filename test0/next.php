...
<?php
    ...
    {?>
    	...
    	<input type="radio" name="answer" value="0"><img src="../obr/obr5.png" width="100" height="100"><br>
    	<input type="radio" name="answer" value="0"><img src="../obr/obr7.png" width="100" height="100"><br>
    	<input type="radio" name="answer" value="1"><img src="../obr/obr9.png" width="100" height="100"><br>
    	<input type="radio" name="answer" value="0"><img src="../obr/obr1.png" width="100" height="100"><br>
