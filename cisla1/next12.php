...
<?php
    ...
    {?>
       ...
       <input type="checkbox" name="answer1" value="1">39<br>
        <input type="checkbox" name="answer2" value="-1">69<br>
       <input type="checkbox" name="answer3" value="-1">26<br>
       <input type="checkbox" name="answer4" value="-1">85<br>
        <input type="checkbox" name="answer5" value="1">52<br>
        <input type="checkbox" name="answer6" value="1">83<br>
